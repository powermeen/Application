...
insert into setup_table (s_module ,s_widget_id ,s_widget_name ,s_data ,s_action_type , s_sequence, s_reference ,i_status) values ('login', 'Login_username','username','papisit' ,'TextBox','1', 'Login_Meen','1');
insert into setup_table (s_module ,s_widget_id ,s_widget_name ,s_data ,s_action_type , s_sequence, s_reference ,i_status) values ('login', 'Login_password','password','Isnsit_12' ,'TextBox','2', 'Login_Meen','1');
insert into setup_table (s_module ,s_widget_id ,s_widget_name ,s_data ,s_action_type , s_sequence, s_reference ,i_status) values ('login', 'Login_submit' ,'submit','' , 'Button' ,'3','Login_Meen','1');
